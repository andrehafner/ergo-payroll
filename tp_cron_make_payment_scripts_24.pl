...
#set a filename var so we can later search for the 24 paycycle to run
my $end_filename = "_24_tokens.py";
...
$sql = "select employee_token_id, employee_token_id from employee where company_wallet_id='@array_access_main[1]' and employee_token_id!='erg' and employee_pay_frequency='24' and employee_active_status='yes' order by id;";
