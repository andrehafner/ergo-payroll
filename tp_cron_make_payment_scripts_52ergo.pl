...
my $end_filename = "_52erg_tokens.py";

#this mysql call gets the company info as a base 
my $sql_access_main = "select company_wallet_deposit_id, company_wallet_id, company_seed_name from employer where company_wallet_deposit_id!='' and company_wallet_id!='' and company_active='yes' and company_52_frequency='yes';";
...
$sql = "select e_company_wallet_id, employee_token_id from employee where company_wallet_id='@array_access_main[1]' and employee_token_id='erg' and employee_pay_frequency='52' and employee_active_status='yes' order by id;";
...
$sql = "select employee_token_count, employee_token_id, employee_usd_amount from employee where company_wallet_id='@array_access_main[1]' and employee_token_id='erg' and employee_pay_frequency='52' and employee_active_status='yes' order by id;";
